...
namespace Bibliotech.Model.DAO
{
    public abstract class Connection
    {
        ...
        private const string CONNECTION_STRING = "Server=localhosts;Port=3306;Database=bibliotech;Username=bibliotech;Password=@bibliotech123;AllowZeroDateTime=true;Allow User Variables=true;";
